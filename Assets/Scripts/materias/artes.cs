...
public class artes : MonoBehaviour
{
    ...
    public TextMeshProUGUI ArteAfricanacount;
    public TextMeshProUGUI ArteContemporaneacount;
    public TextMeshProUGUI DadaismoSurrealismoeFuturismocount;
    public TextMeshProUGUI PreHistoriacount;
    public TextMeshProUGUI Cinemacount;
    public TextMeshProUGUI FolcloreeaDancacount;
    public TextMeshProUGUI HistoriaemQuadrinhoseChargescount;
    public TextMeshProUGUI Musicacount;
    public TextMeshProUGUI Teatrocount;
    ...
    {
        TextAsset jsonFile = Resources.Load<TextAsset>("ArtesData");
    ...
    {
        { "Arte Africana", ArteAfricanacount },
        { "Arte Contemporanea", ArteContemporaneacount },
        { "Dadaismo, Surrealismo e Futurismo", DadaismoSurrealismoeFuturismocount },
        { "Pre-Historia", PreHistoriacount },
        { "Cinema", Cinemacount },
        { "Folclore e a Danca", FolcloreeaDancacount },
        { "Historia em Quadrinhos e Charges", HistoriaemQuadrinhoseChargescount },
        { "Musica", Musicacount },
        { "Teatro", Teatrocount }
    };
