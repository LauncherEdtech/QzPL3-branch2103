...
public class Quimica : MonoBehaviour
{
    ...
    public TextMeshProUGUI Atomísticacount;
    public TextMeshProUGUI ClassificaçãodasCadeiasCarbônicascount;
    public TextMeshProUGUI DensidadeeMassaEspecíficacount;
    public TextMeshProUGUI Estequiometriacount;
    public TextMeshProUGUI LigaçõesQuímicaseInteraçõesIntermolecularescount;
    public TextMeshProUGUI MoleMassaMolarcount;
    public TextMeshProUGUI PropriedadesdaMateriacount;
    public TextMeshProUGUI SeparaçãodeMisturascount;
    public TextMeshProUGUI TabelaPeriódicacount;
    public TextMeshProUGUI Eletroquímicacount;
    public TextMeshProUGUI Termoquímicacount;
    public TextMeshProUGUI Soluçõescount;
    public TextMeshProUGUI pHcount;
    public TextMeshProUGUI CineticaQuimicacount;
    public TextMeshProUGUI EquilibrioQuimicocount;
    public TextMeshProUGUI HidróliseSalinacount;
    ...
    {
        { "Atomística", Atomísticacount },
        { "Classificação das Cadeias Carbônicas", ClassificaçãodasCadeiasCarbônicascount },
        { "Densidade e Massa Específica", DensidadeeMassaEspecíficacount },
        { "Estequiometria", Estequiometriacount },
        { "Ligações Químicas e Interações Intermoleculares", LigaçõesQuímicaseInteraçõesIntermolecularescount },
        { "Mol e Massa Molar", MoleMassaMolarcount },
        { "Propriedades da Matéria", PropriedadesdaMateriacount },
        { "Separação de Misturas", SeparaçãodeMisturascount },
        { "Tabela Periódica", TabelaPeriódicacount },
        { "Eletroquímica", Eletroquímicacount },
        { "Termoquímica", Termoquímicacount },
        { "Soluções", Soluçõescount },
        { "pH", pHcount },
        { "Cinetica Quimica", CineticaQuimicacount },
        { "Equilibrio Quimico", EquilibrioQuimicocount },
        { "Hidrólise Salina", HidróliseSalinacount },
