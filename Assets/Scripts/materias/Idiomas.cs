...
public class Idiomas : MonoBehaviour
{
    ...
    public TextMeshProUGUI LinguaEspanholaIcount;
    public TextMeshProUGUI LinguaEspanholaIIcount;
    public TextMeshProUGUI LinguaInglesaIcount;
    public TextMeshProUGUI LinguaInglesaIIcount;
    ...
    {
        TextAsset jsonFile = Resources.Load<TextAsset>("IdiomasData");
    ...
    {
        { "Lingua Espanhola I", LinguaEspanholaIcount },
        { "Lingua Espanhola II", LinguaEspanholaIIcount },
        { "Lingua Inglesa I", LinguaInglesaIcount },
        { "Lingua Inglesa II", LinguaInglesaIIcount }
    };
