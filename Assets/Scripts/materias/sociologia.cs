...
public class sociologia : MonoBehaviour
{
    ...
    public TextMeshProUGUI trabalho1count;
    public TextMeshProUGUI cidadania1count;
    public TextMeshProUGUI cultura1count;
    public TextMeshProUGUI democraciaeestadocount;
    public TextMeshProUGUI democraciaesociedadecount;
    public TextMeshProUGUI movimentossociaiscount;
    public TextMeshProUGUI politicaeestadocount;
    ...
    {
        TextAsset jsonFile = Resources.Load<TextAsset>("SociologiaData");
    ...
    {
        { "Trabalho 1", trabalho1count },
        { "Cidadania 1", cidadania1count },
        { "Cultura 1", cultura1count },
        { "Democracia e Estado", democraciaeestadocount },
        { "Democracia e Sociedade", democraciaesociedadecount },
        { "Movimentos Sociais", movimentossociaiscount },
        { "Política e Estado", politicaeestadocount }
    };
